        ...
        <div className="flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-2">
          ...
          <div>
            ...
            <p className="mt-4 text-sm md:text-base">
              ...
              <br />
              1. 설문조사를 통해 자신에게 부족한 영양소를 확인, 그에 맞는
              영양제를 추천하는 서비스
              <br />
            ...
            <p className="mt-2 text-sm md:text-base">
              ...
              <br />- 커뮤니티 전체 글 조회 페이지
              <br />- Axios를 사용해 서버에 있는 데이터를 불러옵니다.
              <br />- Redux를 사용해 상태관리를 진행합니다.
              <br />- 약 검색 시 조회되는 약 목록 페이지
              <br />- Axios를 사용해 서버에 있는 데이터를 불러옵니다.
              <br />- Redux를 사용해 상태관리를 진행합니다.
            </p>
            <p className="mt-2 text-sm md:text-base">
        ...
        <div className="flex flex-col md:flex-row items-start space-y-4 md:space-y-0 md:space-x-2">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-bold">
              portfolio
              <a
                href="https://github.com/ggggggggithub/my-portfolio"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 dark:bg-white dark:text-black text-white rounded-full ml-4 px-3 md:px-4 py-2 text-xs md:text-sm hover:bg-gray-700 transition"
              >
              ...
              <a
                href="https://ggggggggithub.github.io/my-portfolio/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gray-800 dark:bg-white dark:text-black text-white rounded-full ml-4 px-3 md:px-4 py-2 text-xs md:text-sm hover:bg-gray-700 transition"
              >
